...
from diffpack.torchdrug import core, utils
from diffpack.torchdrug.data import Dictionary
...
class Graph(core._MetaContainer):
    ...
    To batch graphs with variadic sizes, use :meth:`data.Graph.pack <diffpack.torchdrug.data.Graph.pack>`.
