...
from diffpack.torchdrug import core, data, tasks, metrics, transforms
from diffpack.torchdrug.core import Registry as R
from diffpack.torchdrug.layers import functional
from diffpack.torchdrug import layers
...
class AutoregressiveGeneration(tasks.Task, core.Configurable):
    ...
    :class:`GraphAutoregressiveFlow <diffpack.torchdrug.models.GraphAutoregressiveFlow>` models.
